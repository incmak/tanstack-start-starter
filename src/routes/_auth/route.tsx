...
import { requireGuest } from "@/features/auth/utils/auth-guards";
...
function AuthLayout() {
	return (
		<div className="min-h-screen relative overflow-hidden flex flex-col items-center justify-center p-4 sm:p-6 md:p-8">
			...
			<div className="hidden md:block fixed top-1/4 right-1/4 w-75 h-75 md:w-100 md:h-100 lg:w-125 lg:h-125 bg-primary/8 rounded-full blur-3xl animate-glow-pulse" />
			<div className="hidden md:block fixed bottom-1/4 left-1/4 w-62.5 h-62.5 md:w-87.5 md:h-87.5 lg:w-100 lg:h-100 bg-accent/5 rounded-full blur-3xl animate-glow-pulse stagger-3" />
